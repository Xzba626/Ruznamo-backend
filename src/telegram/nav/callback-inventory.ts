...
export const CALLBACK_INVENTORY: CallbackInventoryEntry[] = [
  ...
  { pattern: 'payment:reject:', kind: 'prefix', role: 'admin', emitsFrom: 'orders', handlerHint: 'rejectReasonSelect' },
  { pattern: 'admin:reject:', kind: 'prefix', role: 'admin', emitsFrom: 'orders', handlerHint: 'rejectWizard' },
