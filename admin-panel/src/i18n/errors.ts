const errorCodeLabels: Record<string, string> = {
  ...
  VERSION_CODE_NOT_INCREASING:
    'Версия уже опубликована.\n\nНовое обновление должно иметь versionCode больше текущей опубликованной версии.\n\nУже опубликованный APK нельзя заменить другим файлом с тем же versionCode.',
  VERSION_CODE_EXISTS: 'Релиз с таким versionCode уже существует.',
  PRIVACY_NOT_FOUND: 'Редакция политики не найдена.',
  PRIVACY_NOT_DRAFT: 'Редактировать можно только черновик политики.',
  PRIVACY_LOCALE_REQUIRED: 'Перед публикацией заполните текст на русском и тоҷикӣ.',
  PRIVACY_PUBLISHED_INVARIANT: 'Нарушение: одновременно больше одной опубликованной политики.',
  PRIVACY_PUBLISH_CONFLICT: 'Публикация политики уже выполняется. Повторите попытку.',
